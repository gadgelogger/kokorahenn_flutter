...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/found.gif
  AssetGenImage get found => const AssetGenImage('assets/images/found.gif');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [appIcon, error, found, splashIcon];
}
